...
public class MainController {
    ...
    @FXML
    private TableView<Map.Entry<Integer, MyTuple<Integer, List<Integer>, Integer>>> semaphoreTable;

    @FXML
    private TableColumn<Map.Entry<Integer, MyTuple<Integer, List<Integer>, Integer>>, Integer> semaphoreIndexColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, MyTuple<Integer, List<Integer>, Integer>>, Integer> semaphoreValueColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, MyTuple<Integer, List<Integer>, Integer>>, List<Integer>> semaphoreListValuesColumn;
    ...
    public void initialize() {
        ...
        semaphoreListValuesColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().second()));
    ...
    private void initSemaphoreTable() {

        ProgramState selectedProgramState = getCurrentProgramState();

        if (selectedProgramState != null) {
            MyISemaphoreTable semaphoreTbl = selectedProgramState.getSemaphoreTable();
            List<Map.Entry<Integer, MyTuple<Integer, List<Integer>, Integer>>> semaphoreList = new ArrayList<>(semaphoreTbl.getContent().entrySet());
