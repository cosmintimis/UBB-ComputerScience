...
public class ProgramState {
    ...
    public ProgramState(MyIStack<IStmt> exeStack, MyIDictionary<String, IValue> symTable, MyIList<IValue> outputList, MyIDictionary<StringValue, BufferedReader> fileTable, MyIHeap<Integer, IValue> heap, IStmt program) {
