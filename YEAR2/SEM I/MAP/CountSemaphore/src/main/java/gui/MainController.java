...
public class MainController {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, List<Integer>> semaphoreListValuesColumn;
    ...
    public void initialize() {
        ...
        semaphoreListValuesColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().getValue()));
    ...
    private void initSemaphoreTable() {
        ...
        if (selectedProgramState != null) {
            ...
            List<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semaphoreList = new ArrayList<>(semaphoreTbl.getContent().entrySet());
