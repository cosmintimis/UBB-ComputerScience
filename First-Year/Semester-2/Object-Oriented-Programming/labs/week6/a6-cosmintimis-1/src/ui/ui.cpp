            ...
            do
            {
                ...
                case 1:
                {
                    ...
                    do
                    {
                        ...
                        if(option == 2)
                        {
                            std::cout << eventsForAGivenMonthOrderedChronologically[index] << std::endl;

                            std::string link = eventsForAGivenMonthOrderedChronologically[index].getLink();
                ...
                case 3:
                {
                    ...
                    std::vector<Event> userEvents = this->service.getUserList();
