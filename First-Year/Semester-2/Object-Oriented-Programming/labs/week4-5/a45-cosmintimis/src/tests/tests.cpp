...
void Test::testAddEvent()
{
    ...
    // std::cout << this->service.getEvent(0);
...
{
    assert(this->service.getAllEvents().getSize() == this->service.numberOfEvents());
}
...
void Test::testGetEventsForAGivenMonthOrderedChronologically()
{
    ...
    assert(eventsForAGivenMonthOrderedChronologically.getSize() == 2);

    Event first = eventsForAGivenMonthOrderedChronologically.getElemByIndex(0);
    Event second = eventsForAGivenMonthOrderedChronologically.getElemByIndex(1);
    ...
    DynamicVector<Event> eventsForAGivenMonthOrderedChronologically2;
    this->service.getEventsForAGivenMonthOrderedChronologically(4, eventsForAGivenMonthOrderedChronologically2);
    assert(eventsForAGivenMonthOrderedChronologically2.getSize() == 4);
}
...
void Test::testAddEventToUserList()
{
    ...
    assert(this->service.getUserList().getSize() == 1);
}
