    ...
    public static List<IStmt> build()
    {
        ...
        IStmt example22 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                new HeapAllocationStmt("v1", new ValueExp(new IntValue(1))),
                                new CompStmt(
                                        new CreateSemaphoreStmt("cnt", new HeapReadingExp(new VarExp("v1"))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
                                                ...
                                                new CompStmt(
                                                        new ForkStmt(
                                                                new CompStmt(
                                                                        ...
                                                                        new CompStmt(
                                                                                new HeapWritingStmt("v1", new ArithExp(  new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)), "*")),
                                                                                new CompStmt(
                                                                                        new HeapWritingStmt("v1", new ArithExp( new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(2)), "*")),
                                                                                        new CompStmt(
                                                                                                new PrintStmt(new HeapReadingExp(new VarExp("v1"))),
                                                                                                new ReleaseStmt("cnt")
                                                                                        )
                                                        ...
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
                                                                new CompStmt(
                                                                        new PrintStmt(new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1)), "-")),
                                                                        new ReleaseStmt("cnt")
                                                                )
                                                        )
                                                )
