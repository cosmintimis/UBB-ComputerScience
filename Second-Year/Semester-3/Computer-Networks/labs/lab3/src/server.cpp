        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              nbytes = snprintf(tmpbuf, sizeof(tmpbuf), "<%s - [%d]> -> %s", getIPAddress(crt, false), crt, buf);
              sendToALL(tmpbuf, nbytes);
              ...
              if (nr == serverNumber)
              {
                ...
                snprintf(buf, sizeof(buf), "You guessed the number!\n");
                send(i, buf, strlen(buf) + 1, 0);
              ...
              {
                snprintf(buf, sizeof(buf), "The number is bigger!\n");
                send(i, buf, strlen(buf) + 1, 0);
              }
              else
              {
                snprintf(buf,sizeof(buf),  "The number is smaller!\n");
                send(i, buf, strlen(buf) + 1, 0);
              }
